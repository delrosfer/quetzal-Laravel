...
<head>
    ...
    <title>Factura - {{ config('app.name', 'Inventory Management System') }}</title>
                    ...
                    <div class="row invoice-info">
                        <div class="col-sm-4 invoice-col">
                            ...
                            <address>
                                ...
                                Telefono: (+880) {{ $company->mobile }} {{ $company->phone !== null ? ', +88'.$company->phone : ''  }}<br>
                        ...
                        <div class="col-sm-4 invoice-col">
                            ...
                            <address>
                                ...
                                {{ $customer->address }}<br>
                                {{ $customer->city }}<br>
                                Telefono: (+880) {{ $customer->phone }}<br>
