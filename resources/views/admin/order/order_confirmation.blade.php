                                        ...
                                        <tbody>
                                            @foreach($order_details as $order_detail)
                                                <tr>
                                                    ...
                                                    <td>{{ $unit_cost = $order_detail->unit_cost, 2 }}</td>
                                                    <td>{{ $unit_cost * $order_detail->quantity, 2 }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-4">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                <th>Pagar</th>
                                                <td class="text-right">{{ $order->pay, 2 }}</td>
                                            </tr>
                                            <tr>
                                                <th>Debe</th>
                                                <td class="text-right">{{ $order->due, 2 }}</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td class="text-right">{{ $order->sub_total, 2 }}</td>
                                            </tr>
                                            <tr>
                                                <th>Iva (12%)</th>
                                                <td class="text-right">{{ $order->vat, 2 }}</td>
                                            </tr>
                                            <tr>
                                                <th>Total:</th>
